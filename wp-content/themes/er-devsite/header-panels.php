...
<a href="https://cerebralpalsy.org.au/" class="cp-logo"><img src="<?php bloginfo('template_directory'); ?>/images/cp-logo-tag.png" alt="Made possible by Cerebral Palsy Australia" /></a>
<a href="<?php bloginfo('url'); ?>/" class="cpa-logo cpa-active"><img src="<?php bloginfo('template_directory'); ?>/images/cpactive-logo-new.png" alt="CP Active" /></a>
</div>
