<div class="row hm-news-feed text-center">
			...
			<div class="col-md-6">
				...
				<div class="hm-news-wrap text-left" style="">
						...
						<?php
							...
							<div class="feedcont itemContent">
								...
								<h3 style="font-size: 1.25rem; margin-top: .5rem;"><a href="<?php the_permalink() ?>"><?php the_title(); ?></a></h3>

								<div class="excerpthm"><p><?php the_excerpt(); ?></p></div>
								
								<a href="<?php the_permalink() ?>" class="btn btn-feed">Read more</a>
			...
			<div class="col-md-6">
				<h2>Our champions</h2>
				<div class="hm-champs-wrap text-left">
				
				
					<!-- custom post query -->

			<?php $loop = new WP_Query( array( 'post_type' => 'our-champions', 'posts_per_page' => '2') ) ; ?>
    ...
    <?php endwhile; wp_reset_query(); ?>
			...
			<div class="text-center" style="margin-bottom: 1rem;"><a href="/our-champions/" class="btn hm-more">More champions</a>
