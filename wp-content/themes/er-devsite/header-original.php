...
<div id="logo">
<a href="https://cerebralpalsy.org.au/" class="cp-logo"><img src="<?php bloginfo('template_directory'); ?>/images/cp-logo.png" alt="Cerebral Palsy Australia" /></a>
<a href="<?php bloginfo('url'); ?>/" class="cpa-logo"><img src="<?php bloginfo('template_directory'); ?>/images/cpactive-logo.png" alt="CP Active" /></a>
</div>
