...
(function ($) {
    ...
    $.fn.ModalWindow = function (options) {
        ...
        let _default = {
            ...
            floatBtnAnimation: [false, 'no', 5, 'wow-animated', 5],// [ Animation Enable, animation, time, animation class, pause time]
        ...
        return this.each(function () {
            ...
            function clickOpenAction() {
                ...
                $(settings.cookie[3]).on('click', function (event) {
                    setModalCookie();
                });
            ...
            function modalButtonAnimation() {
                ...
                setTimeout(function () {
                    $('.' + settings.floatBtn[1]).removeClass(settings.floatBtnAnimation[3] + ' wow-infinite ' + settings.floatBtnAnimation[1]  );
                    modalButtonPause();                   
                }, time)
            }
