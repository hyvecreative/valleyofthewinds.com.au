    ...
    <div class="accordion-block">
        ...
        <div class="accordion-content content">
            <div class="columns is-multiline">
                ...
                <div class="column is-one-third">
					<?php $this->input( $modal_background_img ); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="accordion-block">
        ...
        <div class="accordion-content content">
            ...
            <div class="columns is-multiline">
                ...
                <div class="column is-one-third">
	                <?php $this->select($close_font); ?>
                </div>
                <div class="column is-one-third">
	                <?php $this->select($close_weight); ?>
                </div>
                <div class="column is-one-third">
	                <?php $this->select($close_font_style); ?>
                </div>
                <div class="column is-one-third">
	                <?php $this->number($close_border_radius); ?>
                </div>
                <div class="column  is-one-third">
	                <?php $this->color($close_content_color); ?>
                </div>
                <div class="column  is-one-third">
	                <?php $this->color($close_content_color_hover); ?>
                </div>
                <div class="column  is-one-third">
	                <?php $this->color($close_background_color); ?>
                </div>
                <div class="column  is-one-third">
	                <?php $this->color($close_background_hover); ?>
                </div>
                <div class="column  is-one-third">
                </div>
...
<div class="accordion-wrap">
    <div class="accordion-block">
        <div class="accordion-title">
            <span class="plus"><i class="dashicons dashicons-arrow-down-alt2"></i></span>
            <span class="minus"><i class="dashicons dashicons-arrow-up-alt2"></i></span>
            <span class="faq-title"><?php esc_attr_e( 'Shadow', $this->plugin['text'] ); ?></span>
        </div>
        <div class="accordion-content content">
            <div class="columns is-multiline">
                <div class="column is-half">
					<?php echo $this->select( $shadow ); ?>
                </div>
                <div class="column is-half shadow-block">
					<?php echo $this->number( $shadow_h_offset ); ?>
                </div>
                <div class="column is-half shadow-block">
					<?php echo $this->number( $shadow_v_offset ); ?>
                </div>
                <div class="column is-half shadow-block">
					<?php echo $this->number( $shadow_blur ); ?>
                </div>
                <div class="column is-half shadow-block">
					<?php echo $this->number( $shadow_spread ); ?>
                </div>
                <div class="column is-half shadow-block">
					<?php echo $this->color( $shadow_color ); ?>
                </div>
            </div>
        </div>
    </div>
