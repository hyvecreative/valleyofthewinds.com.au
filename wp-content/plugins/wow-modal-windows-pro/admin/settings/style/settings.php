...
$close_location = array(
	...
	'options' => [
		...
		'topLeft'       => __('Top Left location on the popup', $this->plugin['text']),
		'bottomLeft'    => __('Bottom Left location on the popup', $this->plugin['text']),
		'bottomRight'   => __('Bottom Right location on the popup', $this->plugin['text']),
	],
