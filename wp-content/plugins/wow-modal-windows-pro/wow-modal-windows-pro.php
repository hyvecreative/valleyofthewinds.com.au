...
if ( ! class_exists( 'Wow_Plugin' ) ) :
	...
	final class Wow_Plugin {
		...
		public static function information() {
			...
			$info = array(
				'plugin' => array(
					'name'      => esc_attr__( 'Wow Modal Windows Pro', 'modal-window' ), // Plugin name
					'menu'      => esc_attr__( 'Modal Windows Pro', 'modal-window' ), // Plugin name in menu
					'author'    => 'Wow-Company', // Author
					'prefix'    => 'mwp', // Prefix for database
					'text'      => 'modal-window',    // Text domain for translate files
					'version'   => '4.2.3', // Current version of the plugin
				...
				'url'    => array(
					...
					'home'     => 'https://wow-estore.com/item/wow-modal-windows-pro/',
					'support'  => 'https://wow-estore.com/item/wow-modal-windows-pro/#support',
					'facebook' => 'https://www.facebook.com/wowaffect/',
				),
				'rating' => array(
					'website'  => esc_attr__( 'Wow-Estore', 'bubble-menu' ), // Name site for rating plugin
					'url'      => 'https://wow-estore.com/item/wow-modal-windows-pro/#review',
